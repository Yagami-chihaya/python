...
def init():
    ...
    for jibie in yiyuan_jibie:
        mkpath = r'G:\python\爬虫练习\chinese hospital level/' + jibie
        os.mkdir(mkpath)
    ...
    def sav_message(messgae, province_now, jibie):
        ...
        workbook.save(r'G:\python\爬虫练习\chinese hospital level/' + str(jibie) + '/' + str(province_now) + '医院列表.xls')
